...
{
    [CustomEditor(typeof(PopupAnimFadeOut))]
    public class PopupAnimFadeOutEditor : BasePopupAnimationEditor<PopupAnimFadeOut>
    {
        protected override void DrawInspectorContent(PopupAnimFadeOut anim, bool horizontal)
        {
            if (horizontal)
            {
                EditorGUILayoutEx.AutoWidthRow(
                    ...
                    new System.Action<Rect>[]
                    {
                        ...
                        rect => GUI.Label(rect, "Fade Out", EditorStyles.miniLabel)
                    });
            }
            else
            {
